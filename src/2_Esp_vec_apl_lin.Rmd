...
a.  $[\Id_n]_{\calb}=\1_n$ (per a qualsevol base $\calb$ de $\K^n$),

b.  $$[\Id_n]_{\calb,\cals_n}=	\begin{pmatrix}
            	\mid & \mid &\mid & \mid\\
            	\vec v_1 & \vec v_2 &\cdots&\vec v_n\\
            	\mid & \mid &\mid & \mid
...
c.  $[\Id_n]_{\cals_n,\calb}=[\Id_n]_{\calb,\cals_n}^{-1}$.

d.  $[g\circ f]_{\calb,\calb''}=[g]_{\calb',\calb''}\cdot[f]_{\calb,\calb'}$
    per a totes $f\colon \K^n\to \K^m$ i $g\colon \K^m\to\K^r$
    aplicacions lineals.

e.  $A=[f_A]_{\cals_n,\cals_m}$.

f.  $[f_A]_{\calb,\calb'}= [\Id_m]_{\calb',\cals_m}^{-1} \cdot A \cdot [\Id_n]_{\calb,\cals_n}$.
:::
